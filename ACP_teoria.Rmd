...
requiere considerar un conjunto de elementos que, aunque pueden
analizarse por separado para facilitar su comprensión, deben integrarse
al final para obtener una lectura global coherente del fenómeno
estudiado. El ACP no solo transforma las variables originales en
componentes más manejables, sino que además proporciona herramientas que
permiten comprender la estructura interna de los datos, la contribución
de cada variable y la organización de los individuos en el nuevo espacio
factorial.

En esta sección se describen los principales elementos que intervienen
en dicha interpretación:

### Calidad de la representación

La calidad de la representación se refiere a qué tan bien los
componentes principales retenidos logran describir la información
contenida en las variables originales. Para evaluarla se utiliza la
**varianza explicada acumulada**, la cual indica el porcentaje de
variabilidad total que es capturada por los primeros componentes.

Una buena selección del número de componentes permite representar los
datos en un espacio de menor dimensión sin perder información relevante.
Entre los criterios más utilizados para decidir cuántos componentes
conservar se encuentran:

-   Conservar tantos componentes como sean necesarios para alcanzar un
    **porcentaje mínimo de varianza acumulada**, usualmente entre 70% y
    90%.
-   Conservar los componentes cuyo **autovalor sea mayor que 1** (regla
    de Kaiser).
-   Inspeccionar el **gráfico de sedimentación (scree plot)** para
    identificar el punto donde la varianza explicada deja de disminuir
    de manera pronunciada.

En conjunto, estos criterios permiten asegurar una representación
adecuada del conjunto de datos al reducir su dimensionalidad mediante el
ACP.
